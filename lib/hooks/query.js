...
function populateObject(serviceField, idField, nameServiceAs, nameIdAs) {
  return function (hook) {
    ...
    if (typeof id === 'string') {
      return service.get(id, { user: hook.params.user, authorised: true }).then(function (object) {
        if (!object) {
...
function populateObjects(serviceField, idField, nameServiceAs, nameIdAs) {
  return function (hook) {
    ...
    if (!id) {
      return service.find({ paginate: false }, { user: hook.params.user, authorised: true }).then(function (objects) {
